...
doDeployDependency "$ROOT/services/lts/target/dependency"               "xowl-engine"       "org.xowl.infra"    "$1/felix/bundle"
doDeployDependency "$ROOT/services/lts/target/dependency"               "xowl-server"       "org.xowl.infra"    "$1/felix/bundle"
...
doDeployBundle "$ROOT/services/lts/target"                  "xowl-service-lts-$VERSION.jar"                 "$1/felix/bundle"
