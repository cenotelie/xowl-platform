...
Ontology(<http://xowl.org/platform/schemas/kernel>
    ...
    ObjectPropertyAssertion(rdfs:isDefinedBy :PlatformUser <http://xowl.org/platform/schemas/kernel>)
    SubClassOf(:PlatformUser :Resource)

    Declaration(Class(:PlatformUserGroup))
    DataPropertyAssertion(rdfs:label :PlatformUserGroup "PlatformUserGroup")
    DataPropertyAssertion(rdfs:comment :PlatformUserGroup "Represents a group of users on the xOWL federation platform")
    ObjectPropertyAssertion(rdfs:isDefinedBy :PlatformUserGroup <http://xowl.org/platform/schemas/kernel>)
    SubClassOf(:PlatformUserGroup :Resource)

    Declaration(Class(:PlatformUserRole))
    DataPropertyAssertion(rdfs:label :PlatformUserRole "PlatformUserRole")
    DataPropertyAssertion(rdfs:comment :PlatformUserRole "Represents a role for a users or groups on the xOWL federation platform")
    ObjectPropertyAssertion(rdfs:isDefinedBy :PlatformUserRole <http://xowl.org/platform/schemas/kernel>)
    SubClassOf(:PlatformUserRole :Resource)
    ...
    ObjectPropertyDomain(:hasMember :PlatformUserGroup)
    ...
    ObjectPropertyAssertion(rdfs:isDefinedBy :hasMember <http://xowl.org/platform/schemas/kernel>)

    Declaration(ObjectProperty(:hasAdmin))
    ObjectPropertyDomain(:hasAdmin :PlatformUserGroup)
    ...
    ObjectPropertyAssertion(rdfs:isDefinedBy :hasAdmin <http://xowl.org/platform/schemas/kernel>)

    Declaration(ObjectProperty(:hasRole))
    ObjectPropertyDomain(:hasRole ObjectUnionOf(:PlatformUser :PlatformUserGroup))
    ObjectPropertyRange(:hasRole :PlatformUserRole)
    ...
    ObjectPropertyAssertion(rdfs:isDefinedBy :hasRole <http://xowl.org/platform/schemas/kernel>)

    Declaration(ObjectProperty(:impliesRole))
    ObjectPropertyDomain(:impliesRole :PlatformUserRole)
    ObjectPropertyRange(:impliesRole :PlatformUserRole)
    ...
    ObjectPropertyAssertion(rdfs:isDefinedBy :impliesRole <http://xowl.org/platform/schemas/kernel>)
)