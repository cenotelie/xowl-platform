...
Ontology(<http://xowl.org/platform/schemas/kernel>
    ...
    ObjectPropertyAssertion(rdfs:isDefinedBy :PlatformGroup <http://xowl.org/platform/schemas/kernel>)
    ...
    ObjectPropertyAssertion(rdfs:isDefinedBy :PlatformRole <http://xowl.org/platform/schemas/kernel>)
