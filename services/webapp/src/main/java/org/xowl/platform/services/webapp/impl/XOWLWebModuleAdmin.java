...
public class XOWLWebModuleAdmin extends WebModuleBase {
    ...
    public XOWLWebModuleAdmin() {
        super(XOWLWebModuleAdmin.class.getCanonicalName(), "Platform Administration", "admin", "/web/assets/module-admin.svg");
        ...
        this.items.add(new WebModuleItem("Platform Documentation", "documentation", "/web/assets/platform.svg"));
